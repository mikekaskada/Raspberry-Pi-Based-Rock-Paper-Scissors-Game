...
### Περιγραφή του Κώδικα και Οδηγίες Εγκατάστασης
...
3. **Ορισμός Διαστάσεων, Γωνιών Περιστροφής και Λειτουργιών Αναστροφής**:
   ...
   - Οι εικόνες περιστρέφονται κατά γωνίες `0°, 90°, 180°, 270°`.
...
Αν ο χρήστης έχει 8000 εικόνες σε κάθε κατηγορία και συνολικά 3 κατηγορίες, δηλαδή **paper**, **scissors**, και **rock**, τότε διαθέτει συνολικά 24.000 εικόνες για την εκπαίδευση του μοντέλου του.

Για την εκπαίδευση του μοντέλου στο Teachable Machine:

- **Epochs**: Δεδομένου του μεγάλου αριθμού δεδομένων, ο χρήστης μπορεί να ξεκινήσει με 100 εποχές. Αν παρατηρήσει ότι το μοντέλο δεν βελτιώνεται μετά από κάποιες εποχές, μπορεί να μειώσει τον αριθμό των εποχών για να εξοικονομήσει χρόνο.

- **Batch Size**: Ένα batch size των 512 είναι κατάλληλο για την περίπτωση του, καθώς θα επιτρέπει στο μοντέλο να επεξεργάζεται τις εικόνες πιο αποτελεσματικά. Εάν παρατηρήσει προβλήματα μνήμης, μπορεί να μειώσει το batch size.

Η διαδικασία εκπαίδευσης του μοντέλου θα χρησιμοποιήσει αυτά τα δεδομένα για να μάθει να αναγνωρίζει τα πρότυπα σε κάθε κατηγορία, βελτιώνοντας έτσι την ακρίβεια του μοντέλου.
